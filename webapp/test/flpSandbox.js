		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Model filter @ client level",
									"targetURL": "#comtatatechmodelfilter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtatatechmodelfilter-display": {
								"semanticObject": "comtatatechmodelfilter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tatatech.modelfilter",
									"url": sap.ui.require.toUrl("com/tatatech/modelfilter")
								}
							}
						}
					}
